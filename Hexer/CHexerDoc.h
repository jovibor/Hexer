...
public:
	...
	[[nodiscard]] auto GetUniqueDocName() -> std::wstring_view;
	...
	void SaveDataToDisk();
	[[nodiscard]] static auto GetUniqueDocName(const ut::DATAOPEN& dos) -> std::wstring;
	[[nodiscard]] static auto GetDocTitle(const ut::DATAOPEN& dos) -> std::wstring;
private:
